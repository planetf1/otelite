...
#[openapi(
    paths(
        ...
        crate::api::genai::get_tool_switch_overhead,
        ...
        crate::api::genai::get_session_depth_cost,
        crate::api::genai::get_time_in_tool,
        ...
        crate::api::genai::get_recent_errors,
    ...
    components(
        schemas(
            ...
            otelite_core::api::RecentErrorRow,
            otelite_core::api::RecentErrorsResponse,
            crate::api::genai::RecentErrorsQuery,
        )
    ),
    tags(
...
impl DashboardServer {
    ...
    pub fn build_router(&self) -> Router {
        let api = Router::new()
            ...
            .route("/api/genai/tool_switch_overhead", get(crate::api::genai::get_tool_switch_overhead))
            ...
            .route("/api/genai/session_depth_cost", get(crate::api::genai::get_session_depth_cost))
            .route("/api/genai/time_in_tool", get(crate::api::genai::get_time_in_tool))
            ...
            .route("/api/genai/recent_errors", get(crate::api::genai::get_recent_errors))
            // API routes - Sessions
